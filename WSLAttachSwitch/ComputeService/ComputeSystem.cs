...
internal class ComputeSystem : SafeHandle
{
    ...
    [DllImport("computecore.dll", ExactSpelling = true, PreserveSig = false, CharSet = CharSet.Unicode)]
    private static extern void HcsGetComputeSystemProperties(ComputeSystem computeSystem, HcsOperation operation,
        string propertyQuery);

    [DllImport("computecore.dll", ExactSpelling = true, PreserveSig = false, CharSet = CharSet.Unicode)]
    private static extern void HcsModifyComputeSystem(ComputeSystem computeSystem, HcsOperation operation,
        string configuration, IntPtr identity);
    ...
    public string Modify(string resourcePath, ModifyRequestType requestType, JsonObject settings,
        JsonObject guestRequest)
    {
